...
//  SwiftUIDemo
//
//  Created by luoquan on 2022/10/21.
...
enum CalculatorBrain {
    ...
    func applyOp(op: CalculatorButtonItem.Op) -> CalculatorBrain {
        switch self {
        case .left(let left):
            switch op {
    ...
    func applyCommand(command: CalculatorButtonItem.Command) -> CalculatorBrain {
        return self
    }
